...
export function AddExpenseScreen() {
  ...
  const { accounts, categories, isLoading, submitExpense } = useTransactionCreation('expense');
  ...
  const handleSubmit = async () => {
    ...
    if (success) {
      ...
      Alert.alert('Gagal', 'Terjadi kesalahan saat mencatat pengeluaran.');
    }
  };
      ...
      <AppScreen style={styles.container}>
        <View style={styles.noAccountContainer}>
          ...
          <AppText variant="bodyMuted" style={styles.noAccountDesc}>
            Anda harus membuat akun (Tunai, Bank, atau E-Wallet) terlebih dahulu sebelum mencatat pengeluaran.
          </AppText>
          <AppButton
    ...
    <AppScreen style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <AppText variant="bodyMuted" style={styles.subtitle}>
          Uang keluar dari akun Anda untuk pembelian barang atau jasa.
        </AppText>
        ...
        <View style={styles.actionButtons}>
          <AppButton
            title={isSubmitting ? 'Menyimpan...' : 'Simpan Pengeluaran'}
